...
Cohesion: 0.15
Nodes (12): T, Parses an LLM response into the specified Pydantic model., Any, T, Loads a JSON string into a Python object., Validates parsed JSON against the specified Pydantic model., Generic parser for converting raw LLM responses into validated Pydantic models., Parses a raw LLM response into the specified Pydantic model.          Args: (+4 more)
